...
#' Generate a custom ggplot2 theme element.
#'
#' @param title_size Font size for the title.
#' @param title_color Color for the title.
#' @param fill_color Background color.
#' @param axis_size Font size for axis labels.
#' @param axis_color Color for axis labels.
#' @param font_family Font family.
#' @param label Input text label (optional).
