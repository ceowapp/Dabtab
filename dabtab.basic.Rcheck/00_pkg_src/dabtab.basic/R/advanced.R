...
filename <<- list.files(path = "~/R/win-library/4.1/dabtab_rs/dabtab.basic/R/data")
                      ...
                      .logout-btn {
                        ...
                        " )
                         ...
                         shiny::navbarMenu(
                           "Menu",
                           icon = icon("bars"),
                           shiny::tabPanel("Username", id = "tab18", titlePanel(uiOutput("username_tab"))),
                           shiny::tabPanel("Permission", id = "tab13", icon = icon("user-tag"), titlePanel(uiOutput("permission_tab"))),
                           shiny::tabPanel("Settings", id = "tab14", icon = icon("cog")),
                           shiny::tabPanel("Support", id = "tab15", icon = icon("hands-helping")),
                           shiny::tabPanel("More Info", id = "tab16", icon = icon("info-circle"))
                         ),
