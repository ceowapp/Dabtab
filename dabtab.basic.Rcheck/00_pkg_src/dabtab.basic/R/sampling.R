...
samplingUI <- dashboardPage(
  ...
  dashboardBody(
    ...
    div(
      class = "btn-group",
      actionButton("go_to_process_page", icon("arrow-left"), "Go to Process Page", class = "btn btn-primary"),
      actionButton("go_to_advanced_page", icon("arrow-right"), "Go to Advanced Page", class = "btn btn-success")
    ),
