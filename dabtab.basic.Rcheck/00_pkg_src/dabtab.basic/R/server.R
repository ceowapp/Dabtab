...
df_1<-read.csv("~/R/win-library/4.1/dabtab_rs/dabtab.basic/R/data/202204-divvy-tripdata_v2.csv")


d_pkg_dependencies_path <- "~/R/win-library/4.1/dabtab_rs/dabtab.basic/R/data/pkg_dependencies.csv"
d_pkg_releases_path <- "~/R/win-library/4.1/dabtab_rs/dabtab.basic/R/data/pkg_releases.csv"
d_pkg_title_path<- "~/R/win-library/4.1/dabtab_rs/dabtab.basic/R/data/tile_summary.rds"
d_pkg_details_path<- "~/R/win-library/4.1/dabtab_rs/dabtab.basic/R/data/pkg_details.rds"


path_fix<-"~/R/win-library/4.1/dabtab_rs/dabtab.basic/data"
path_sufix<-"~/R/win-library/4.1/dabtab_rs/dabtab.basic/data/"
domains_path <- "~/R/win-library/4.1/dabtab_rs/dabtab.basic/data/treechart_test.csv"
