...
## design menu
options(
  radiant.basic_local_ui =
  shiny::navbarPage("Dynamic Application",
                      ...
                      .logout-btn {
                         ...
                         shiny::navbarMenu(
                           ...
                           shiny::tabPanel(
                            ...
                            tabPanel(
                                ...
                                navbarMenu(
                                  "Generate Reports",
                                  shiny::tabPanel("HMTL", value = "html_report", id = "tab100", icon = icon("file-pdf")),
                                  shiny::tabPanel("PDF", value = "pdf_report", id = "tab100", icon = icon("file-pdf")),
                                  shiny::tabPanel("Word", value = "word_report", id = "tab101", icon = icon("file-word")),
                                  shiny::tabPanel("PPTX", value = "pptx_report", id = "tab102", icon = icon("file-powerpoint")),
                                  shiny::tabPanel("shinyHTML", value = "shinyHtml_report", id = "tab103", icon = icon("file-powerpoint")),
                                  shiny::tabPanel("shinyPPTX", value = "shinyPptx_report", id = "tab104", icon = icon("file-powerpoint")),
                                  shiny::tabPanel("More Info", id = "tab104", icon = icon("info-circle"))
                                )
                              )
                            ),
                            mainPanel(
                        ...
                        # Session Management Tab
                         navbarMenu(
                           "Session Management",
                           icon = icon("bars"),
                           tabPanel("Download State", id = "tab13", icon = icon("user-tag"), titlePanel(uiOutput("permission_tab"))),
                           tabPanel("Upload State", id = "tab14", icon = icon("cog")),
                           tabPanel("New Session", id = "tab14", icon = icon("cog")),
                           tabPanel("Refresh", id = "tab14", icon = icon("cog")),
                           tabPanel("Stop", id = "tab14", icon = icon("cog")),
                           tabPanel("Configure Settings", id = "tab14", icon = icon("cog"))
                           #with this users can manually configure the autosave time or whether or not they want autosave which adds up memory usage,
...
FOR SERVER FEATURES IF USERS TRIGGER CERTAIN EVENTS FROM THEIR LOCAL SYSTEM THESE ELEMENTS WILL BE 


STILL KEEP UPGRADE BUTTON IN CASE USERS UPGRADE NOTIFY WHAT FEATURES ARE INCLUDED IN THE ADVANCED 
